...
namespace TEN::Renderer
{
	...
	void Renderer::CreateVolConeTargets(int w, int h)
	{
		// Float-Targets, keine sRGB, kein MSAA, kein eigener Depth-Stencil
		_volConeFrontZ = RenderTarget2D(_device.Get(), w, h, DXGI_FORMAT_R32_FLOAT, false, DXGI_FORMAT_UNKNOWN);
		_volConeBackZ = RenderTarget2D(_device.Get(), w, h, DXGI_FORMAT_R32_FLOAT, false, DXGI_FORMAT_UNKNOWN);
