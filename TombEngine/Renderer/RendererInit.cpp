...
namespace TEN::Renderer
{
	...
	void Renderer::InitializeScreen(int w, int h, HWND handle, bool reset)
	{
		...
		_SSAODepthDownscaled = RenderTarget2D(_device.Get(), w / SSAO_DOWNSCALE_FACTOR, h / SSAO_DOWNSCALE_FACTOR, DXGI_FORMAT_R32_FLOAT, false, DXGI_FORMAT_UNKNOWN);
		_SSAONormalsDownscaled = RenderTarget2D(_device.Get(), w / SSAO_DOWNSCALE_FACTOR, h / SSAO_DOWNSCALE_FACTOR, DXGI_FORMAT_R8G8B8A8_UNORM, false, DXGI_FORMAT_UNKNOWN);
		_SSAORenderTarget = RenderTarget2D(_device.Get(), w / SSAO_DOWNSCALE_FACTOR, h / SSAO_DOWNSCALE_FACTOR, DXGI_FORMAT_R8G8B8A8_UNORM, false, DXGI_FORMAT_UNKNOWN);
		_SSAOBlurredRenderTarget = RenderTarget2D(_device.Get(), w / SSAO_DOWNSCALE_FACTOR, h / SSAO_DOWNSCALE_FACTOR, DXGI_FORMAT_R8G8B8A8_UNORM, false, DXGI_FORMAT_UNKNOWN);
