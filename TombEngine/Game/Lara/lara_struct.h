...
enum LaraState
{
	...
	// the two are never live concurrently. Must precede NUM_LARA_STATES so the implicit
	// count reflects 210 (and PlayerBehaviorStateRoutines is sized accordingly), not 199.
