...
enum LaraAnim
{
	...
	LA_TNT_DETONATOR_USE = 576,				// Use TNT detonator
	LA_GONG_STRIKE = 577,					// Strike gong
	LA_PULL_DAGGER_FROM_DRAGON = 578,		// Pull dagger from DRAGON boss.
	LA_MIDAS_GOLD_SWITCH = 579,
...
enum LaraExtraAnim
{
	// LEA_PULL_DAGGER_FROM_DRAGON = 0,		DEPRECATED: use LA_PULL_DAGGER_FROM_DRAGON instead. Stranger1992 07/01/2026
	LEA_WAKE_UP = 1,
	...
	LEA_SHIVA_DEATH = 7,
	// LEA_ACTIVATE_TNT_SWITCH = 8,			DEPRECATED: use LA_TNT_DETONATOR_USE instead. Stranger1992 07/01/2026
	// LEA_MIDAS_GOLD_SWITCH = 9,			DEPRECATED: use LA_MIDAS_GOLD_SWITCH instead. Stranger1992 07/01/2026
	LEA_MIDAS_DEATH = 10,
	// LEA_STRIKE_GONG = 11,			 	DEPRECATED: use LA_GONG_STRIKE instead. Stranger1992 07/01/2026
