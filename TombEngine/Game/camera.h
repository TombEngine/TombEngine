...
// Legacy lifecycle entry points (called from control.cpp, trigger.cpp). Implemented on top of g_Camera.
void PrepareCamera();
void UpdateCamera();
bool TestLockedCamera();

// Legacy collision clamp used by kayak vehicle code (kept verbatim from develop).
