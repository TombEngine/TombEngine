...
bool FindAITargetObject(CreatureInfo* creature, int objectNumber); // True if AI target found.
bool FindAITargetObject(CreatureInfo* creature, int objectNumber, int ocb, bool checkSameZone = true); // True if AI target found.
