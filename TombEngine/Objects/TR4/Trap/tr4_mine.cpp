			...
			if (!spheres.empty())
			{
				for (int i = 0; i < spheres.size(); i++)
				{
					...
					if (i >= 7 && i != 9)
					{
						...
						auto minePose = Pose(Vector3i(sphere.Center));
						TriggerShockwave(&minePose, 48, 304, (GetRandomControl() & 0x1F) + 112, 0, 96, 128, 32, EulerAngles(2048, 0.0f, 0.0f), 0, true, false, false, (int)ShockwaveStyle::Normal);
					}
				}
