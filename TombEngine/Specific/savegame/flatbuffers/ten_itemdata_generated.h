...
template<> struct ItemDataTraits<TEN::Save::ItemFXInfo> {
...
struct ItemDataUnion {
  ...
  TEN::Save::ItemFXInfoT *AsItemFXInfo() {
    return type == ItemData::ItemFXInfo ?
      reinterpret_cast<TEN::Save::ItemFXInfoT *>(value) : nullptr;
  }
  const TEN::Save::ItemFXInfoT *AsItemFXInfo() const {
    return type == ItemData::ItemFXInfo ?
      reinterpret_cast<const TEN::Save::ItemFXInfoT *>(value) : nullptr;
  }
};
...
inline flatbuffers::Offset<ItemFXInfo> CreateItemFXInfo(flatbuffers::FlatBufferBuilder &_fbb, const ItemFXInfoT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return TEN::Save::CreateItemFXInfo(
      _fbb,
      _counter,
      _flag1,
      _flag2);
...
inline bool VerifyItemData(flatbuffers::Verifier &verifier, const void *obj, ItemData type) {
  switch (type) {
    ...
    case ItemData::ItemFXInfo: {
      auto ptr = reinterpret_cast<const TEN::Save::ItemFXInfo *>(obj);
      return verifier.VerifyTable(ptr);
    }
    default: return true;
  }
...
inline flatbuffers::Offset<void> ItemDataUnion::Pack(flatbuffers::FlatBufferBuilder &_fbb, const flatbuffers::rehasher_function_t *_rehasher) const {
  switch (type) {
    ...
    case ItemData::ItemFXInfo: {
      auto ptr = reinterpret_cast<const TEN::Save::ItemFXInfoT *>(value);
...
inline ItemDataUnion::ItemDataUnion(const ItemDataUnion &u) : type(u.type), value(nullptr) {
  switch (type) {
    ...
    case ItemData::ItemFXInfo: {
      value = new TEN::Save::ItemFXInfoT(*reinterpret_cast<TEN::Save::ItemFXInfoT *>(u.value));
      break;
    }
    default:
      break;
...
inline void ItemDataUnion::Reset() {
  switch (type) {
    ...
    case ItemData::ItemFXInfo: {
      auto ptr = reinterpret_cast<TEN::Save::ItemFXInfoT *>(value);
      delete ptr;
      break;
    }
    default: break;
