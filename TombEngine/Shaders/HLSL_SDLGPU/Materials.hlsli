...
#ifndef REG_TEX_SSAO
#define REG_TEX_SSAO t9
#endif
#ifndef REG_SMP_SSAO
#define REG_SMP_SSAO s9
#endif
Texture2D SSAOTexture : register(REG_TEX_SSAO);
SamplerState SSAOSampler : register(REG_SMP_SSAO);

#ifndef REG_TEX_ORSH
#define REG_TEX_ORSH t10
#endif
#ifndef REG_SMP_ORSH
#define REG_SMP_ORSH s10
#endif
Texture2D ORSHTexture : register(REG_TEX_ORSH);
SamplerState ORSHSampler : register(REG_SMP_ORSH);

#ifndef REG_TEX_EMISSIVE
#define REG_TEX_EMISSIVE t11
#endif
#ifndef REG_SMP_EMISSIVE
#define REG_SMP_EMISSIVE s11
#endif
Texture2D EmissiveTexture : register(REG_TEX_EMISSIVE);
SamplerState EmissiveSampler : register(REG_SMP_EMISSIVE);

#ifndef REG_TEX_LEGACY_REFLECTIONS
#define REG_TEX_LEGACY_REFLECTIONS t12
#endif
#ifndef REG_SMP_LEGACY_REFLECTIONS
#define REG_SMP_LEGACY_REFLECTIONS s12
#endif
Texture2D LegacyReflectionsTexture : register(REG_TEX_LEGACY_REFLECTIONS);
SamplerState LegacyReflectionsSampler : register(REG_SMP_LEGACY_REFLECTIONS);

#ifndef REG_TEX_SKYBOX_REFLECTIONS
#define REG_TEX_SKYBOX_REFLECTIONS t13
#endif
#ifndef REG_SMP_SKYBOX_REFLECTIONS
#define REG_SMP_SKYBOX_REFLECTIONS s13
#endif
Texture2DArray SkyboxReflectionsTexture : register(REG_TEX_SKYBOX_REFLECTIONS);
SamplerState SkyboxReflectionsSampler : register(REG_SMP_SKYBOX_REFLECTIONS);
