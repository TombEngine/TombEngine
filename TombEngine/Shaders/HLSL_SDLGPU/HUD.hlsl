...
#ifdef VERTEX_SHADER
// VS CBs: HUDBuffer(10) -> contiguous b0
#define REG_CB_HUD b0
// VS unused CBs -> after VS-used
#define REG_CB_HUD_BAR b1
// VS unused textures -> all t0/s0
#define REG_TEX_HUD t0
#define REG_SMP_HUD s0
#else
// PS CBs: HUDBarBuffer(11) -> contiguous b0
#define REG_CB_HUD_BAR b0
// PS unused CBs -> after PS-used
#define REG_CB_HUD b1
// PS textures -> contiguous t0
#define REG_TEX_HUD t0
#define REG_SMP_HUD s0
#endif
...
cbuffer HUDBuffer : register(REG_CB_HUD)
{
	float4x4 View;
	float4x4 Projection;
};
...
cbuffer HUDBarBuffer : register(REG_CB_HUD_BAR)
{
	float2 BarStartUV;
	float2 BarScale;
	//------------
...
Texture2D Texture : register(REG_TEX_HUD);
SamplerState Sampler : register(REG_SMP_HUD);
