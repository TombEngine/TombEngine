// @SDLGPU_RESOURCE_MAP
// VS_UBO: 0=0 13=1
// PS_UBO: 0=0 13=1 12=2
// PS_TEX: 0=0 6=1
// @END_RESOURCE_MAP
#pragma pack_matrix(row_major)

#ifdef VERTEX_SHADER
// VS CBs: Camera(0), InstancedSprites(13) -> contiguous b0-b1
#define REG_CB_CAMERA b0
#define REG_CB_INSTANCED_SPRITES b1
...
#else
// PS CBs: Camera(0), InstancedSprites(13), Blending(12) -> contiguous b0-b2
#define REG_CB_CAMERA b0
#define REG_CB_INSTANCED_SPRITES b1
#define REG_CB_BLENDING b2
...
cbuffer InstancedSpriteBuffer : register(REG_CB_INSTANCED_SPRITES)
{
