...
namespace TEN::Scripting::Types
{
	...
	{
		using ctors = sol::constructors<ScriptColor(), ScriptColor(unsigned char, unsigned char, unsigned char), ScriptColor(unsigned char, unsigned char, unsigned char, unsigned char)>;
