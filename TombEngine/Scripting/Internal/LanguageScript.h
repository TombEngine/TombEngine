...
#define STRING_ATMOSPHERIC_SKY_QUALITY	"atmospheric_sky_quality"
#define STRING_QUALITY_LOW				"low"
#define STRING_QUALITY_MEDIUM			"medium"
#define STRING_QUALITY_HIGH				"high"
