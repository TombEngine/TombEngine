@echo off
echo ============================================================
echo  TombEngine - Generate Visual Studio 2026 Solution
echo ============================================================
echo.
...
if exist "Build\msvc-2026\CMakeCache.txt" (
...
echo.
echo    Build\msvc-2026\TombEngine.slnx
echo.
