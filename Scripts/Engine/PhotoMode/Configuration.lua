...
Configuration.Weapons =
{
    ...
    { name = TEN.Flow.GetString("pistols"),  objID = TEN.Objects.ObjID.PISTOLS_ANIM, meshIndices = {10, 13}, weaponType = TEN.Objects.WeaponType.PISTOLS, pickupObjID = TEN.Objects.ObjID.PISTOLS_ITEM, type = "holsters", gunFlash = true },
    { name = TEN.Flow.GetString("pistols").."(Right)",  objID = TEN.Objects.ObjID.PISTOLS_ANIM, meshIndices = {10}, weaponType = TEN.Objects.WeaponType.NONE, pickupObjID = TEN.Objects.ObjID.PISTOLS_ITEM,type = "right", gunFlash = false },
    { name = TEN.Flow.GetString("pistols").."(Left)",  objID = TEN.Objects.ObjID.PISTOLS_ANIM, meshIndices = {13}, weaponType = TEN.Objects.WeaponType.NONE, pickupObjID = TEN.Objects.ObjID.PISTOLS_ITEM,type = "left", gunFlash = false },
    ...
    { name = TEN.Flow.GetString("uzis"),  objID = TEN.Objects.ObjID.UZI_ANIM, meshIndices = {10, 13}, weaponType = TEN.Objects.WeaponType.UZIS, pickupObjID = TEN.Objects.ObjID.UZI_ITEM,type = "holsters", gunFlash = true },
    { name = TEN.Flow.GetString("revolver"),  objID = TEN.Objects.ObjID.REVOLVER_ANIM, meshIndices = {10}, weaponType = TEN.Objects.WeaponType.REVOLVER, pickupObjID = TEN.Objects.ObjID.REVOLVER_ITEM,type = "right", gunFlash = true },
    { name = TEN.Flow.GetString("hk"),  objID = TEN.Objects.ObjID.HK_ANIM, meshIndices = {10}, weaponType = TEN.Objects.WeaponType.HK, pickupObjID = TEN.Objects.ObjID.HK_ITEM,type = "back", gunFlash = true },
